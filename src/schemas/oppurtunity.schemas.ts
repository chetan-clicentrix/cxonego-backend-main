...
export const OpportunitySchema = z.object({
    ...
    stage: z.enum(["Analysis", "Solutioning", "Closed"] as const),
    status: z.enum(["Active", "Inactive", "Cancelled", "Won", "Lost"] as const),
    priority: z.enum(["Low", "Medium", "High"] as const),
    wonReason: z.enum(["Need Fulfilled", "Competitive Advantage", "Relationship & Trust", "Competitive Pricing", "UpSelling/CrossSelling", "Effective Sales Process", "Other"] as const).nullable().optional(),
    lostReason: z.enum(["Budget Constraint", "Competitive Selection", "Changed Needs/Priority", "Decision Making Delay", "No Purchase Intent", "Ineffective Sales Process", "Uncompetitive Pricing", "Product/Service Limitations", "Lack of Followup or Communication", "Other"] as const).nullable().optional(),
